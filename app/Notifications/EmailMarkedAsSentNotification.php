...
class EmailMarkedAsSentNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => $this->sender->name . ' marked confirmation email as sent for task "' . $this->task->title . '" to: ' . $toEmailsString,
