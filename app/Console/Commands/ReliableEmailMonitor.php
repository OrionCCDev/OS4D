...
class ReliableEmailMonitor extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'emails:reliable-monitor {--max-results=50 : Maximum number of emails to fetch}';
     ...
     * @var string
     */
    protected $description = 'Reliable email monitoring with better error handling and no mutex issues';
    ...
    {
        $this->info('🚀 Starting RELIABLE email monitoring...');
        ...
        try {
            ...
            Log::info('ReliableEmailMonitor: Successfully completed', [
            ...
            Log::error('ReliableEmailMonitor: Exception occurred', [
