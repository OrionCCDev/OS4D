<?php
/**
 * Fix User Notifications and Test System V2
 *
 * This script fixes the user notification issue and tests the complete system
 * Updated to handle missing CC column gracefully
 */

require_once __DIR__ . '/vendor/autoload.php';

echo "=== Fix User Notifications and Test System V2 ===\n";
...
try {
    ...
    // Step 3: Check recent emails and their CC field
    ...
    // Step 4: Fix existing emails that might have CC data in cc_emails but not cc
    ...
    // Step 5: Test notification creation for existing emails
    ...
    // Step 6: Check current notifications
