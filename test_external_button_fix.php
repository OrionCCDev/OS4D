...
try {
    ...
    echo "\n🧪 Testing markEmailAsSent functionality (External Button)...\n";
    ...
    try {
        ...
        if ($responseData['success']) {
            echo "   ✅ markEmailAsSent SUCCESS! (External Button)\n";
            ...
            echo "   ❌ markEmailAsSent FAILED! (External Button)\n";
    ...
    echo "3. Click 'Done (Mark as Sent)' button in the modal\n";
    echo "4. Should work without error now!\n";
