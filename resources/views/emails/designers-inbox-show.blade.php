...
@section('head')
<style>
/* Reset and base styles - FULL WIDTH */
.email-details-page {
    width: 100%;
    max-width: 100%;
    overflow-x: hidden;
...
.email-details-page .container-fluid {
    max-width: 100%;
    padding-left: 20px;
    padding-right: 20px;
}

/* Fix breadcrumb positioning issue */
.email-details-page .modern-breadcrumb,
.email-details-page [class*="breadcrumb"] {
...
.email-details-page .card-header {
    background: #f8f9fa;
    border-bottom: 1px solid #dee2e6;
    padding: 15px 25px;
}

/* Email content container - FULL WIDTH */
...
<script>
    ...
    function showAlert(type, message) {
        ...
        `;
        const cardBody = document.querySelector('.email-details-page .card-body');
        if (cardBody) {
