            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-0">{{ $client->mobile ?? 'N/A' }}</p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-muted">Position</label>
                        <p class="mb-0">{{ $client->position ?? 'N/A' }}</p>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-0"><span class="badge bg-info">{{ ucfirst($client->role) }}</span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <p class="mb-0">{{ $client->created_at->format('M d, Y h:i A') }}</p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-muted">Last Updated</label>
                        <p class="mb-0">{{ $client->updated_at->format('M d, Y h:i A') }}</p>
                    </div>
                </div>
            </div>
        </div>
